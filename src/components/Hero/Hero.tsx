      ...
      <div className="flex flex-col items-center justify-center text-center max-w-full mx-auto mt-6">
        <Fade direction="down" triggerOnce duration={1000}>
          <img
            src={AirPodsImg}
            alt="airpods"
            className="mx-auto mb-2 w-2/4 md:w-full"
          />
        </Fade>
        <Fade direction="up" triggerOnce duration={1000}>
          <div className="mt-5">
            ...
            <h1 className="text-3xl lg:text-6xl font-bold my-8">
              Sound, that sounds better!
            </h1>
            <p className="text-gray-700 mb-6 mt-4 font-normal text-sm lg:text-lg">
